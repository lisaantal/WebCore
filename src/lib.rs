...
#[derive(Debug)]
pub struct WebCoreProcessor {
    verbose: bool,
    processed_count: usize,
}

impl WebCoreProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting WebCore processing");
    
    let mut processor = WebCoreProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = WebCoreProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = WebCoreProcessor::new(false);
